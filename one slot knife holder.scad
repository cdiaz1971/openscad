...
translate([0,0.1,0])rotate([90, 180,0])peghookbase(7.5);
//base
translate([25,0,0])difference(){
    cube([28,50,35], center=true);
    
    
translate([0,0,0]) cube([21.5,30.5,36], center = true);
/*slots
   
    translate([-10,0,0]) cube([12.6,26,36], center = true);
    #translate([10,0,0]) cube([12.6,26,36], center = true);
    translate([0,90,0]) cube([12.6,26,36], center = true);
    translate([0,-45,0]) cube([12.6,26,36], center = true);
    translate([0,-90,0]) cube([12.6,26,36], center = true);
*/
//holes
    /*translate([0,0,0])cylinder(r=rad, h=36, center=true);
    translate([0,15,0])cylinder(r=rad, h=36, center=true);
    translate([0,30,0])cylinder(r=rad, h=36, center=true);
    translate([0,-30,0])cylinder(r=rad, h=36, center=true);
    translate([0,-15,0])cylinder(r=rad, h=36, center=true);
    translate([0,45,0])cylinder(r=rad, h=36, center=true);
    translate([0,-45,0])cylinder(r=rad, h=36, center=true);
    translate([0,60,0])cylinder(r=rad, h=36, center=true);
    translate([0,-60,0])cylinder(r=rad, h=36, center=true);
    translate([0,75,0])cylinder(r=rad, h=36, center=true);
    translate([0,-75,0])cylinder(r=rad, h=36, center=true);
    */
};
