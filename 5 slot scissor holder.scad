...
translate([20,0,0])difference(){
    cube([20,187,35], center=true);
    
//slots
   
    translate([0,0,0]) cube([12.6,26,36], center = true);
    translate([0,35,0]) cube([12.6,26,36], center = true);
    translate([0,70,0]) cube([12.6,26,36], center = true);
    translate([0,-35,0]) cube([12.6,26,36], center = true);
    translate([0,-70,0]) cube([12.6,26,36], center = true);
//holes
